...
namespace Christoc.Modules.CoursePluggComment
{
    ...
    /// 
    /// Because the control inherits from CoursePluggCommentSettingsBase you have access to any custom properties
    /// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class Settings : CoursePluggCommentModuleSettingsBase
    {
